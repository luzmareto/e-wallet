DB_SOURCE=postgresql://postgres:lala@172.31.16.1:5432/ewallet?sslmode=disable

postgresql :
	docker run --name postgres-ewallet -p 4321:5432 -e TZ=Asia/Jakarta -e POSTGRES_USER=root -e POSTGRES_PASSWORD=secret -d postgres
